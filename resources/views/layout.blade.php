    ...
    <div class="dashboard">
      ...
      <aside class="dashboard-status-bar">
        ...
        <ul class="navigation-menu">
          ...
          <li><a href="/support" data-balloon="{{ __('dashboard.support') }}" data-balloon-pos="right"><span class="screen-reader-text">{{ __('dashboard.support') }}</span><?php echo file_get_contents( 'svg/dashboard/support.svg' ); ?></a></li>
